...
public class TC001_DoubleClickTest {
    @Test
    public void double_click_test(){
        ...
        String expectedStyleAttributeText = "red";
        Assert.assertTrue(actualStyleAttributeValue.contains(expectedStyleAttributeText));
    }
}
